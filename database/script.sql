...
-- SEQUENCE: public.student_vaccine_link_id_seq
-- DROP SEQUENCE IF EXISTS public.student_vaccine_link_id_seq;

CREATE SEQUENCE IF NOT EXISTS public.student_vaccine_link_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
...
ALTER SEQUENCE public.student_vaccine_link_id_seq
    OWNER TO school_user;
...
/* Create vaccination_drives table next */
...
/* Create student_vaccine_link table last */
...
ALTER SEQUENCE public.student_vaccine_link_id_seq
    OWNED BY public.student_vaccine_link.id;